...
export default async function getRecipes(
  ...
  const getRecipesbyCategory = Selectedcategory.split('').length > 1 ? { category: Selectedcategory } : {};
  ...
  /**
   * This is mainly used to filter data,
   * when the condition above are met, results will then be filtered by that expression.
   */
  const matchby = {
    $and: [getRecipesbyTags,
